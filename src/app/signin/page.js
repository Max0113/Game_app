        ...
        <div className='w-screen h-screen flex justify-center items-center'>
            <form className='p-10 w-125 bg-[#5a5a5a32] backdrop-blur-2xl rounded-2xl form invisible translate-y-4'>
                ...
                <div className='*:m-1 my-3'>
                    ...
                    <input id='name' type='text' className='text-white text-[0.8rem] w-full outline-none px-5 py-3 border-1 border-[#9d9d9d] rounded-sm appearance-none' placeholder='Email'  required/>
                </div>
                <div className='*:m-1 my-3'>
                    <lable  className='text-[0.8rem] text-white font-medium'>Email *</lable>
                    <input  id='email' type='text' className='text-white text-[0.8rem] w-full outline-none px-5 py-3 border-1 border-[#9d9d9d] rounded-sm appearance-none' placeholder='Email'  required/>
                </div>
                <div className='*:m-1 relative my-3'>
                    ...
                    <div id='password' onClick={() => SetActive(!Active)} className='absolute right-4 top-1/2 text-white cursor-pointer'>{Active ? <MdOutlineVisibility />  : <MdOutlineVisibilityOff />}</div>
                </div>
